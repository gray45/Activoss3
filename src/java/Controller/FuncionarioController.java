...
public class FuncionarioController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("agregar".equals(action)) {
            ...
            add(Integer.parseInt(split[0]),cedula,split[1]);
        }
...
private List<Dependencia> findAllDependencias() {
    ...
    private void add(Integer dependencia, String cedula, String dependenciaNombre) {
        Funcionario funcionario = new Funcionario(dependencia, cedula, dependenciaNombre);
        FuncionarioDao dao = new FuncionarioDao();
        try {
